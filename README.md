...
minutes, then click the link the notebook prints. Nothing is installed on your computer, you get
your own private session, and the demo dataset opens with segmentation and tracking already
computed so you go straight to visualisation, track editing and the analysis tabs.
