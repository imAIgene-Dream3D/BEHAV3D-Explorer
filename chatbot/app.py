...
def build_system_prompt(context: dict, retrieved: list[dict], tools: list[dict]) -> str:
    ...
    rules = (
        ...
        "Do not suggest LapTrack or TrackPy unless there is a concrete, explainable reason to prefer one.\n"
        ...
        "multicellular-structure populations coexist, track them together with Fragmentation Propagation when "
